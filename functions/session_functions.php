...
// pulls the Species Information and loads it into Session Variables 
/*	function loadSpeciesToSession(){
		$_SESSION['speciesInfo'] = array();
	
		$_SESSION['speciesInfo']['petTypeId'] = $speciesInfo['petTypeId'];
